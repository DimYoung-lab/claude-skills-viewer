...
- **外部技能自动识别**: 自动检测未在映射中定义的技能（通过 GitHub 等外部方式获取的技能）
- **紫色标识**: 外部获取的技能显示紫色边框和背景，便于区分
- **外部文件夹支持**: 外部技能文件夹（如 superpowers）及其子技能统一使用紫色主题
- **自动提取信息**: 从 SKILL.md 的 frontmatter 自动提取名称和描述，无需手动配置
- **智能 Emoji**: 未映射的技能自动生成基于名称的一致性 Emoji 图标
